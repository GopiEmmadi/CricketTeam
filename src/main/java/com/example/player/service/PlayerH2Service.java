...
public class PlayerH2Service implements PlayerRepository {
    ...
    public Player addPlayer(Player player) {
        ...
        return db.queryForObject("select * from team where playerName=? and jerseyNumber=? and role=?", new PlayerRowMapper(),
    ...
    public ArrayList<Player> getPlayers() {
        // TODO Auto-generated method stub
        return new ArrayList<>(db.query("select * from team", new PlayerRowMapper()));
    }
}